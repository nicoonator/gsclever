	...
	public Return click(int playerId, Area area, int fieldId) throws Exception {
		...
		case dices:
			...
			case yellow:
				...
				players[playerId].getManagement().enterCrossOrNumber(Area.yellow, currentFieldId,
			...
			case blue:
				...
				players[playerId].getManagement().enterCrossOrNumber(Area.blue, currentFieldId,
			...
			case white:
				...
				if (currentArea[playerId] == Area.blue) {
					players[playerId].getManagement().enterCrossOrNumber(currentArea, currentFieldId,
			...
			case green:
				...
				players[playerId].getManagement().enterCrossOrNumber(Area.green, currentFieldId,
			...
			case orange:
				...
				players[playerId].getManagement().enterCrossOrNumber(Area.orange, currentFieldId,
			...
			case purple:
				...
				players[playerId].getManagement().enterCrossOrNumber(Area.purple, currentFieldId,
